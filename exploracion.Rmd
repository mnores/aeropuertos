...
## En esta sección analizaremos la parte de mercado de vuelos que se llevó cada aerolínea. Para ello vamos a implementar un código que calcula el tiempo de vuelo total y la cantidad total de pasajeros que viajó en cada aerolínea.
